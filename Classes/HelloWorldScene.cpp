...
bool HelloWorld::init()
{
    ...
    auto clippingContent = Sprite::create("griff.png");
    
    addChild(clippingContent);
    
    clippingContent->setPosition(Vec2(visibleSize.width/2, visibleSize.height/2));
    
    auto clipNode = ClippingNode::create(clippingContent);
